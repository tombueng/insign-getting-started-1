...
public interface InsignApiService {
    ...
    InsignBasicResult getSessionMetadata(String sessionId);

    // ==================== External Signing ====================

    /** Starts the external signing flow for multiple signers. */
    InsignBasicResult beginExtern(InsignExternConfig config);
    ...
    InsignBasicResult getExternUsers(String sessionId);

    /** Returns detailed info about the external signing state. */
    InsignBasicResult getExternInfos(String sessionId);
